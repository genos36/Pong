...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET libudev::libudev
                 ...
                 $<$<CONFIG:Release>:${libudev_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET libudev::libudev
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${libudev_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET libudev::libudev
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${libudev_LIB_DIRS_RELEASE}>)
    set_property(TARGET libudev::libudev
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${libudev_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET libudev::libudev
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${libudev_COMPILE_OPTIONS_RELEASE}>)
